...
void MyTestFunction(void)
{
	...
	char nameD[100] = "The quick     brown  fox     ";
	RemoveSpaces(nameA);
	RemoveSpaces(nameB);
	RemoveSpaces(nameC);
	RemoveSpaces(nameD);
	...
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	AddMoveToBoard(board7, size7, 'N', 0, 2, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	...
	AddMoveToBoard(board7, size7, 'N', 0, 1, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	AddMoveToBoard(board7, size7, 'S', 0, 2, &rowPosition, &colPosition);
	printf("   Token position: row=%d, col=%d\n", rowPosition, colPosition);
	...
	AddMoveToBoard(board8, size8, 'S', 3, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, size8, 'S', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, size8, 'S', 3, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, size8, 'S', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, size8, 'S', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, size8, 'S', 4, 1, &rowPos, &colPos);
	for (int i = 0; i < size8; i++) {
		printf("   ");
		for (int j = 0; j < size8; j++) {
			printf("%d ", board8[i][j]);
	...
	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'S', 1, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 1, &rowPos, &colPos);
	
	GetDisplayBoardString(board8, 6, boardString);
	printf("%s", boardString);

	GetMoveBot1(board8, 6, 1, &side, &move);
	AddMoveToBoard(board8, 6, side, move, 1, &lastRow, &lastCol);
	GetDisplayBoardString(board8, 6, boardString);
	printf("%s", boardString);
	...
	printf("\n3 WITH ONE SPACE ROW:\n");
	printf("===================\n");

	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'S', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'S', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'S', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'S', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 1, &rowPos, &colPos);
	...
	printf("\n3 WITH ONE SPACE COL:\n");
	printf("===================\n");


	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'W', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 1, &rowPos, &colPos);
	...
	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'W', 4, 1, &rowPos, &colPos);
	...
	InitialiseBoard(board8, 6);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'N', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 0, 2, &rowPos, &colPos);
	...
	printf("%s", boardString);
	 ...
	 InitialiseBoard(board8, 6);
	 AddMoveToBoard(board8, 6, 'N', 1, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 1, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 1, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 1, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 1, 1, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 4, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 4, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 4, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 4, 2, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 4, 1, &rowPos, &colPos);
	 AddMoveToBoard(board8, 6, 'N', 3, 1, &rowPos, &colPos);
	...
	AddMoveToBoard(board8, 6, 'S', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'S', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 3, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 6, 'E', 2, 1, &rowPos, &colPos);
	...
	InitialiseBoard(board8, 5);
	AddMoveToBoard(board8, 5, 'N', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'N', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'N', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'N', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'N', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'E', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'S', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'S', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 5, 'S', 4, 1, &rowPos, &colPos);



	GetDisplayBoardString(board8, 5, boardString);
	printf("%s", boardString);

	GetMoveBot1(board8, 5, 1, &side, &move);
	AddMoveToBoard(board8, 5, side, move, 1, &lastRow, &lastCol);
	GetDisplayBoardString(board8, 5, boardString);
	printf("%s", boardString);
	...
	InitialiseBoard(board8, 7);
	AddMoveToBoard(board8, 7, 'W', 0, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 1, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'E', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'S', 4, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 5, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 5, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 5, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'E', 2, 1, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 4, 2, &rowPos, &colPos);
	AddMoveToBoard(board8, 7, 'W', 3, 1, &rowPos, &colPos);
	...
	GetDisplayBoardString(board8, 7, boardString);
	printf("%s", boardString);

	GetMoveBot1(board8, 7, 1, &side, &move);
	AddMoveToBoard(board8, 7, side, move, 1, &lastRow, &lastCol);
	GetDisplayBoardString(board8, 7, boardString);
	printf("%s", boardString);
